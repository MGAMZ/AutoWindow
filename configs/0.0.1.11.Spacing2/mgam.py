...
pre_crop_data_root = '/file1/Totalsegmentator_dataset_v201/spacing2_crop80_ccm0.5_npz/'
mha_data_root = '/file1/Totalsegmentator_dataset_v201/spacing2_mha/'
...
grad_accumulation = 8 if not debug else 2
