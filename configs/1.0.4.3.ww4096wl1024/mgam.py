...
from mgamdata.dataset.FLARE_2023.mm_dataset import (
    FLARE_2023_Mha, FLARE_2023_Precrop_Npz)
...
# Dataset
pre_crop_data_root = '/home/zhangyq.sx/mgam_datasets/FLARE_2023_Data/spacing2_crop64_ccm0.9_npz/'
mha_data_root = '/home/zhangyq.sx/mgam_datasets/FLARE_2023_Data/spacing2_mha'
num_classes = 15
val_sample_ratio = 0.1
wl = 1024    # window loacation
ww = 4096    # window width
pad_val = 0
seg_pad_val = 0
